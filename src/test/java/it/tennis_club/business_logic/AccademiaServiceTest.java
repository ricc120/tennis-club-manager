...
public class AccademiaServiceTest {
        ...
        void testCreateLezione() throws AccademiaException, PrenotazioneException {
                ...
                Integer id = accademiaService.creaLezione(dataTest, oraTest, campoTest, utenteMaestroTest,
                                "Descrizione test");
        ...
        void testInserisciDescrizione() throws AccademiaException, PrenotazioneException {
                ...
                assertNotNull(lezione.getId(), "L'ID della lezione non dovrebbe essere null");
                lezione.setDescrizione("Descrizione test");
                assertTrue(accademiaService.inserisciDescrizione(lezione.getId(), "Descrizione Test"),
                                "La descrizione dovrebbe essere inserita con successo");

                System.out.println(lezione + " descrizioni inserite con successo");
        }
        ...
        void testDeleteLezione() throws AccademiaException, PrenotazioneException {
                ...
                prenotazioneCreate = lezione.getPrenotazione();
                assertNotNull(lezione.getId(), "L'ID della lezione non dovrebbe essere nullo");
                assertTrue(accademiaService.cancellaLezione(lezione.getId()),
                                "La lezione dovrebbe essere stata eliminata correttamente");

                System.out.println(lezione + " lezione eliminata correttamente");
        }
        ...
        void testGetLezioneByMaestro() throws AccademiaException, PrenotazioneException {
                Integer id = accademiaService.creaLezione(dataTest, oraTest, campoTest, utenteMaestroTest,
                                "Descrzione Test");
                idsLezioniTest.add(id);
                List<Lezione> lezioni = accademiaService.getLezionePerMaestro(utenteMaestroTest);
                assertNotNull(lezioni, "La lista di lezioni non dovrebbe essere null");
                for (Lezione l : lezioni) {
        ...
        void testGetLezioneByPrenotazione() throws AccademiaException, PrenotazioneException, SQLException {
                ...
                for (Lezione l : lezioni) {
                        l = accademiaService
                                        .getLezionePerPrenotazione(prenotazioneDAO.getPrenotazioneById(idPrenotazione));
        ...
        void testAggiungiAllievo() throws AccademiaException, PrenotazioneException, SQLException {
                Integer id = accademiaService.creaLezione(
                ...
                Lezione lezione = accademiaService.getLezionePerId(id);
                assertNotNull(lezione, "La lista di lezioni non dovrebbe essere null");
                prenotazioneCreate = lezione.getPrenotazione();
                ...
                System.out.println(
                                "Allievo " + utenteAllievoTest.getId() + " aggiunto alla lezione " + lezione.getId()
                                                + " con successo");
        }
        ...
        void testRimuoviAllievo() throws AccademiaException, PrenotazioneException, SQLException {
                ...
                System.out.println(
                                "Allievo " + utenteAllievoTest.getId() + " rimosso dalla lezione " + lezione.getId()
                                                + " con successo");
        }
        ...
        void testGetLezioniAllievo() throws AccademiaException, PrenotazioneException {
                ...
                System.out
                                .println("Recuperate " + lezioniAllievo.size() + " lezioni per l'allievo "
                                                + utenteAllievoTest.getId());
        }
        ...
        void testSegnaPresenza() throws AccademiaException, SQLException, PrenotazioneException {
                ...
                boolean risultatoPresente = accademiaService.segnaPresenza(lezione.getId(), utenteAllievoTest.getId(),
                                true);

                assertTrue(risultatoPresente, "La presenza dovrebbe essere stata segnata con successo");

                boolean risultatoAssente = accademiaService.segnaPresenza(lezione.getId(), utenteAllievoTest.getId(),
                                false);
        ...
        void testCreateLezioneParametriNull() {
                ...
                assertThrows(AccademiaException.class,
                                () -> accademiaService.creaLezione(null, oraValida, campoTest, utenteMaestroTest,
                                                "Descrizione"),
                                "Dovrebbe lanciare eccezione con data null");

                // Test con ora null
                assertThrows(AccademiaException.class,
                                () -> accademiaService.creaLezione(dataFutura, null, campoTest, utenteMaestroTest,
                                                "Descrizione"),
                                "Dovrebbe lanciare eccezione con ora null");

                // Test con campo null
                assertThrows(AccademiaException.class,
                                () -> accademiaService.creaLezione(dataFutura, oraValida, null, utenteMaestroTest,
                                                "Descrizione"),
                                "Dovrebbe lanciare eccezione con campo null");

                // Test con maestro null
                assertThrows(AccademiaException.class,
                                () -> accademiaService.creaLezione(dataFutura, oraValida, campoTest, null,
                                                "Descrizione"),
        ...
        void testGetLezioneByIdInesistente() {
                ...
                assertThrows(AccademiaException.class,
                                () -> accademiaService.getLezionePerId(idInesistente),
        ...
        void testDeleteLezioneInesistente() throws AccademiaException {
                ...
                boolean risultato = accademiaService.cancellaLezione(idInesistente);
        ...
        void testRimuoviAllievoNonIscritto() throws AccademiaException, PrenotazioneException {
                ...
                Lezione lezione = accademiaService.getLezionePerId(id);
                assertNotNull(lezione, "Dovrebbe esistere almeno una lezione");
                ...
                System.out.println(
                                "Eccezione correttamente lanciata per rimozione allievo non iscritto: "
