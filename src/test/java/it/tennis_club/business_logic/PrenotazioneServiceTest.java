...
public class PrenotazioneServiceTest {
        ...
        public void testCreaPrenotazioneDataPassata() throws PrenotazioneException {
                ...
                PrenotazioneException exception = assertThrows(
                                ...
                                () -> prenotazioneService.creaPrenotazione(dataPassata, oraTest, campoTest,
                                                utenteTest));
        ...
        public void testCreaPrenotazioneOrarioNonValido() throws PrenotazioneException {
                ...
                PrenotazioneException exception = assertThrows(
                                PrenotazioneException.class,
                                () -> prenotazioneService.creaPrenotazione(dataTest, oraTroppoPresto, campoTest,
                                                utenteTest));
        ...
        public void testGetPrenotazioniPerData() throws PrenotazioneException {
                ...
                Integer id2 = prenotazioneService.creaPrenotazione(dataTest, oraTest.plusHours(1), campoTest,
                                utenteTest);
        ...
        public void testGetPrenotazioniPerCampo() throws PrenotazioneException {
                ...
                System.out.println(
                                "Trovate " + prenotazioni.size() + " prenotazioni per il campo " + campoTest.getNome());
        }
        ...
        public void testGetPrenotazioniPerSocio() throws PrenotazioneException {
                ...
                Integer id2 = prenotazioneService.creaPrenotazione(dataTest.plusDays(1), oraTest.plusHours(1),
                                campoTest,
                                utenteTest);
                idsPrenotazioniTest.add(id2);
                ...
                for (Prenotazione p : prenotazioni) {
                        assertEquals(utenteTest.getId(), p.getSocio().getId(),
                                        "Tutte le prenotazioni dovrebbero essere per il socio "
                                                        + utenteTest.getEmail());
                }

                System.out.println("Trovate " + prenotazioni.size() + " prenotazioni per il socio "
                                + utenteTest.getEmail());
        }
        ...
        public void testValidazioneParametriNull() {
                assertThrows(PrenotazioneException.class,
                                () -> prenotazioneService.creaPrenotazione(null, LocalTime.now(), campoTest,
                                                utenteTest));

                assertThrows(PrenotazioneException.class,
                                () -> prenotazioneService.creaPrenotazione(LocalDate.now().plusDays(1), null, campoTest,
                                                utenteTest));

                assertThrows(PrenotazioneException.class,
                                () -> prenotazioneService.creaPrenotazione(LocalDate.now().plusDays(1), LocalTime.now(),
                                                null,
                                                utenteTest));
        ...
        public void testGetPrenotazioneByIdEsistente() throws PrenotazioneException {
                Integer id = prenotazioneService.creaPrenotazione(
                                dataTest, oraTest, campoTest, utenteTest);
                idsPrenotazioniTest.add(id);
                Integer idEsistente = prenotazioneService.getPrenotazioni().get(0).getId();

                Prenotazione prenotazione = prenotazioneService.getPrenotazionePerId(idEsistente);
        ...
        public void testGetPrenotazioneByIdInesistente() {
                ...
                assertThrows(PrenotazioneException.class,
                                () -> prenotazioneService.getPrenotazionePerId(idInesistente),
                                "Dovrebbe lanciare un'eccezione per ID inesistente");
