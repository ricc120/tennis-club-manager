...
class PrenotazioneServiceTest {
    ...
    void testCreaPrenotazioneDataPassata() {
        ...
        PrenotazioneException ex = assertThrows(PrenotazioneException.class,
                () -> prenotazioneService.creaPrenotazione(dataPassata, oraValida, campoTest, socioTest));
    ...
    void testCreaPrenotazioneOrarioNonValido() {
        assertThrows(PrenotazioneException.class,
                () -> prenotazioneService.creaPrenotazione(dataFutura, LocalTime.of(7, 0), campoTest, socioTest));
        assertThrows(PrenotazioneException.class,
                () -> prenotazioneService.creaPrenotazione(dataFutura, LocalTime.of(23, 0), campoTest, socioTest));
    }
    ...
    void testCreaPrenotazioneManutenzioneAttiva() throws Exception {
        ...
        PrenotazioneException ex = assertThrows(PrenotazioneException.class,
                () -> prenotazioneService.creaPrenotazione(dataFutura, oraValida, campoTest, socioTest));
