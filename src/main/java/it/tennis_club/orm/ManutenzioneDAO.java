...
public class ManutenzioneDAO {
     ...
     * @throws SQLException se si verifica un errore durante l'accesso al database
     */
    public void updateStatoManutenzione(Integer idManutenzione, Manutenzione.Stato nuovoStato) throws SQLException {
        Connection connection = null;
        PreparedStatement statement = null;
     ...
     * @throws SQLException se si verifica un errore durante l'accesso al database
     */
    public void completaManutenzione(Integer idManutenzione, java.time.LocalDate dataFine) throws SQLException {
        Connection connection = null;
        PreparedStatement statement = null;
